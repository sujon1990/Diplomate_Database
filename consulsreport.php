...
<div class="form-popup" id="myForm">
  <h4><form action="listhonoraryconsuls.php" class="form-container">
    <label for="Country" style="padding-left: 10px">Select Organization</label>
        <select name="country" id="country" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT country FROM person WHERE infotype = 'Honorary_Consuls' ORDER BY country ASC");
...
<!--                        <strong>-->
<!--                </h1>-->
<!--                <h2>Honorary Consuls Reports</h2>-->
<!--            </div>-->
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Honorary Consuls Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
      ...
      <a onclick="openForm()">List of Consuls |</a> 
      <a href="advanceconsuls.php">Advance Search</a> 
