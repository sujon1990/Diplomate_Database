    ...
    <div >
       ...
       <h3 align="center"  >Add Personal Profile</h3>
        ...
        <div align="center" style="font-family: 'Times New Roman', sans-serif;">
            <form method="post" action="getdependent.php" enctype="multipart/form-data">
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><strong>: </strong>
                         <input type="text" name="designation" value=""  required size="50">
                        </td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th><label>11.  Nationality</label></th>
                        <td><strong>: </strong>
                    ...
                    <tr>
                        <th> <label>13. Date of Birth</label></th>
                    ...
                    <tr>
                        <th> <label>14. Place of Birth</label></th>
                    ...
                    <tr>
                        <th> <label>16. Passport No</label></th>
                    ...
                    <tr>
                        <th> <label>17. Passport Type</label></th>
...
<!-- 
                    <tr>
                        <th> <label>18. Location</label></th>
                        <td><strong>: </strong><textarea  name="location"    rows="4" cols="50" ></textarea></td>
                    </tr>
 ...
 -->
                    <tr>
                        <th> <label>18. Office Address</label></th>
                    ...
                    <tr>
                        <th> <label>19. Residence Address</label></th>
                    ...
                    <tr>
                     ...
                     <tr>
                        <th> <label>20. Contact Details :</label></th>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <th> <label>21. Name of the person by whom dependent to (if status is dependent)</label></th>
                        <td><strong>: </strong><input type="text" name="depname" value=""   size="50"></td>
                    ...
                    <tr>
                        <th> <label>22. Passport of the person by whom dependent to (if status is dependent)</label></th>
                        <td><strong>: </strong><input type="text" name="deppass" value=""   size="50"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><strong>: </strong><input type="text" name="edu" value=""   size="50"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><strong>: </strong><textarea  name="exp"    rows="4" cols="50" ></textarea></td>
                    </tr>
