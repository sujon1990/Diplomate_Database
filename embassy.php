...
<div class="form-popup" id="myForm">
  <h4><form action="embassyreport.php" class="form-container">
    <label for="embassy" style="padding-left: 10px">Select Country</label>
        <select name="embassy" id="embassy" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT embassy FROM embassyform  ORDER BY embassy ASC");
                while($row=mysqli_fetch_array($query))
                { ?>
                    <option value="<?php echo $row['embassy'];?>"><?php echo $row['embassy'];?></option>
                    <?php
                }
                ?>
        </select>
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Embassy Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
      ...
      <a onclick="openForm()">Embassy |</a> 
      <a href="localembassyreport.php">Local Staff |</a> 
      <a href="foreignembassyreport.php">Foreign Staff |</a> 
      <a onclick="openForm()">List of Deputured Staff Staff |</a>   
