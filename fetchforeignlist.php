...
{
    $selectedcountry=mysqli_real_escape_string($connect,$_POST["selectedcountry"]);

   

    if($selectedcountry!=''){
        $selectedcountryQuery="AND country="."'$selectedcountry'";
    }else{
        $selectedcountryQuery="";
    }
	...
	$query = "
	SELECT * FROM person 
	WHERE infotype = 'Embassy' AND emptype = 'Foreign' AND  $selectedcountryQuery ;
	";
    // echo $query;
}
else
