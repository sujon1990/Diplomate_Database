...
<div class="form-popup" id="myForm">
  <h4><form action="listforeignembassyemployee.php" class="form-container">
    <label for="Country" style="padding-left: 10px">Select Country</label>
        <select name="country" id="country" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT country FROM person WHERE infotype='Embassy' AND emptype='Foreign' ORDER BY country ASC");
...
<!--                        <strong>-->
<!--                </h1>-->
<!--                <h2>Embassy Forign Employee Reports</h2>-->
<!--            </div>-->
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Embassy Foreign Employee Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
        <a href="embassy.php">BACK |</a>
        <a href="index.php">Home |</a> 
       <!--  <button onclick="openForm()">List of Employee |</button>
 -->    <a onclick="openForm()" >List of Employee |</a>
        <a href="advanceforeignembassyemployee.php">Advance Search</a>
