...
<div class="form-popup" id="myForm">
  <h4><form action="listforeignintorgemployee.php" class="form-container">
    <label for="Country" style="padding-left: 10px">Select Organization</label>
        <select name="oname" id="oname" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT oname FROM person WHERE infotype = 'Inetrnational Organization' AND emptype='Foreign' ORDER BY oname ASC");
...
<!--                        <strong>-->
<!--                </h1>-->
<!--                <h2>Intl. Organization Forign Employee Reports</h2>-->
<!--            </div>-->
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Intl. Organization Foreign Employee Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
        ...
        <a href="advanceforeignintorgemployee.php">Advance Search</a>
