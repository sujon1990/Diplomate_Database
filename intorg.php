...
<div class="form-popup" id="myForm">
  <h4><form action="intorgreport.php" class="form-container">
    <label for="oname" style="padding-left: 10px">Select Country</label>
        <select name="oname" id="oname" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT oname FROM intorgform  ORDER BY oname ASC");
...
<!--                        <strong>-->
<!--                </h1>-->
<!--                <h2>Intl. Organization Reports</h2>-->
<!--            </div>-->
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Intl. Organization Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
      ...
      <a onclick="openForm()">Organization</a> |
      <a href="localintorgreport.php">Local Staff</a> |
      <a href="foreignintorgreport.php">Foreign Staff</a> 
