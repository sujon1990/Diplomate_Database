...
<?php
$ona =  $_GET['oname'];
$sql = "SELECT * FROM project.intorgform WHERE oname= '".$ona."' ";
...
<body>
        ...
        <div id="customers" align="center">
            ...
            <table style="margin-top: -17%">
                ...
                <tr>
                    <h4 align="center" > <u style="font-weight:  normal; font-family: "Cambria", arial, sans-serif" >Intl. Organization's Information</u></h4>
        ...
        <tr><th width="30%" align="left" style="vertical-align: text-top; font-weight: normal; font-family: "Cambria", arial, sans-serif">1. Name of the Organization :</th><td width="70%"> <?php echo $oname; ?></td></tr>
        <tr><th width="30%" align="left" style="vertical-align: text-top; font-weight: normal; font-family: "Cambria", arial, sans-serif">2. Country :</th><td width="70%"> <?php echo $country; ?></td></tr>
        <tr>
            <th align="left" style="vertical-align: text-top; font-weight: normal; font-family: "Cambria", arial, sans-serif">3. Name of Organization Head :</th>
            <td><?php echo $name;?></td>
        ...
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">4. Starting Date :</th><td><?php echo $sdate; ?></td></tr>

         
        
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">5. Location :</th><td><?php echo $location; ?></td></tr><br>
        ...
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">6. Contact Details :</th><td></td></tr><br>
        ...
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">7. Total Number of Employee :</th><td><?php echo $noe; ?></td></tr><br>
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">8. Number of Local Employee :</th><td><?php echo $sumlocalempembassy; ?></td></tr><br>
        <tr><th align="left" style="vertical-align: text-top; font-weight:  normal; font-family: "Cambria", arial, sans-serif">9. Number of Foreign Employee :</th><td><?php echo $sumforeignempembassy; ?></td></tr><br>
    ...
    <div align="center"><button class="btn btn-info" onclick="printPageArea('printableArea')">Print This Page</button></div>
