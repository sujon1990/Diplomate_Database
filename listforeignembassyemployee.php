...
<div class="container">
    ...
    <div align="center" class="table-responsive" id="printableArea">
    	<h2 align="center">List of Foreign Employee - <?php echo $coun; ?> </h2><br />
        <table  class="table table bordered" id="listview" style="text-align: center; width: 100%;" >
...
<?php
$coun =  $_GET['country'];
$sql = "SELECT * FROM project.person WHERE infotype = 'Embassy' AND emptype = 'Foreign' AND dep = ' ' AND country = '".$coun."' ORDER BY deppass ASC ";
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        echo '<tr> 
                 ...
                 <!-- <td style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">'.$deppass.'</td>-->  
                  ...
                  <!-- <td style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">'.$dep.'</td>-->
