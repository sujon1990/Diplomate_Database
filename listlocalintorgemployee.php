...
<div class="container">
    ...
    <div align="center" class="table-responsive" id="printableArea">
    	<h2 align="center">List of Local Employee - <?php echo $oname; ?> </h2><br />
...
<?php
$oname =  $_GET['oname'];
$sql = "SELECT * FROM project.person WHERE infotype = 'Inetrnational Organization' AND  emptype = 'Local' AND dep=' ' AND oname = '".$oname."' ";
