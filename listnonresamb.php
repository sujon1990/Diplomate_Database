...
<div class="container">
    ...
    <div align="center" class="table-responsive" id="printableArea">
        <h2 align="center">List of Non-Resident Ambassador - <?php echo $coun; ?> </h2><br />
...
<?php
$coun =  $_GET['country'];
$sql = "SELECT * FROM project.person WHERE infotype = 'Non-Resident Ambassador' AND dep=' ' AND country='".$coun."' ORDER BY deppass ASC";
