...
<div class="container">
    ...
    <div align="center" class="table-responsive" id="printableArea">
        <h2 align="center">List of Non-Resident DA & MA - <?php echo $coun; ?> </h2><br />
        <table  class="table table bordered" id="listview" style="text-align: center;" >
            ...
            <tr>
                ...
                <th style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">Passport Number</th>
                <th style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">Contact Info</th>
                <th style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">Photo</th>
...
$coun =  $_GET['country'];
$sql = "SELECT * FROM project.person WHERE infotype = 'Non-Resident DA MA' AND dep=' ' AND  country ='".$coun."'ORDER BY deppass ASC";
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        echo '<tr> 
                 ...
                 <!-- <td style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;">'.$deppass.'</td>-->     
                  ...
                  <td style=" color: black; border: 1px solid #ddd; padding: 8px; vertical-align: top;"><img class="img-responsive" src="images/'.$pp .'"/  width="150px" height="150px" alt=" Image Not Found"></td>  
