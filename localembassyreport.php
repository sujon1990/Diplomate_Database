...
<div class="form-popup" id="myForm">
  <h4><form action="listlocalembassyemployee.php" class="form-container">
    <label for="Country" style="padding-left: 10px">Select Country</label>
        <select name="country" id="country" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT country FROM person WHERE infotype='Embassy' AND emptype='Local' ORDER BY country ASC");
...
<!--                        <strong>-->
<!--                </h1>-->
<!--                <h2>Embassy Local Employee Reports</h2>-->
<!--            </div>-->
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Embassy Local Employee Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    ...
    <a href="embassy.php">BACK |</a>
        ...
        <a href="advancelocalembassyemployee.php">Advance Search </a>  
