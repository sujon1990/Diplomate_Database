...
<div class="form-popup" id="myForm">
  <h4><form action="listnonresdama.php" class="form-container">
    <label for="Country" style="padding-left: 10px">Select Organization</label>
        <select name="country" id="country" >
                <option value="">Select</option>
                <?php $query =mysqli_query($connect,"SELECT DISTINCT country FROM person WHERE infotype = 'Non-Resident DA MA' ORDER BY country ASC");
...
<div align="center" style="color: black">
    ...
    <div style="color: #722B90; font-size: 400%;">Non-Resident DA & MA Reports</div>
    <br>
    <img src="img/Picture1.png" height="225px" width="225px">
</div>
...
<div id="footer">
    <h4>
        ...
        <a onclick="openForm()">List of Non-Resident DA & MA |</a> 
        <a href="advancelistnonresdama.php">Advance Search </a> 
    </h4>
</div>
