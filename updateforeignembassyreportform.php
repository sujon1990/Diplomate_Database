...
<div id="customers" align="center">
    ...
    <form method="post" action="updateforeignembassyreport.php" enctype="multipart/form-data" onsubmit="return confirm('Are You Sure to Update the Data?');">
        <table align="center">
            ...
            <tr>
             ...
             <tr>
                     ...
                     <tr>
                        ...
                        <td><input type="text" name="oname" value="<?php echo $oname; ?>"  size="50"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><textarea  name="location"    rows="4" cols="50" ><?php echo $location; ?></textarea></td>
                    </tr>
                    ...
                    <tr>
                     ...
                     <tr>
            <tr>
                        <th> <label>23. Family Information :</label></th>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-left: 52px;padding-right:20px"><input type="text" name="spouse" placeholder="Name" value="<?php echo $spouse; ?>"   size="40"></td>
                        <td><input type="text" name="kids" placeholder="Passport Number" value="<?php echo $kids; ?>"   size="50"></td>
                    ...
                    <tr>
                        <td style="padding-left: 52px;padding-right:20px"><input type="text" name="spouse2" placeholder="Name" value="<?php echo $spouse2; ?>"   size="40"></td>
                        <td><input type="text" name="kids2" placeholder="Passport Number" value="<?php echo $kids2; ?>"   size="50"></td>
                        <td style="padding-left: 20px">
                             <select name="relation2">
                                <option value="<?php echo $relation2; ?>"><?php echo $relation2; ?></option>
                                <option value="Father">Father</option>
                                <option value="Mother">Mother</option>
                                <option value="Siblings">Siblings</option>
                                <option value="Spouse">Spouse</option>
                    ...
                    <tr>
                        <td style="padding-left: 52px;padding-right:20px"><input type="text" name="spouse3" placeholder="Name" value="<?php echo $spouse3; ?>"   size="40"></td>
                        <td><input type="text" name="kids3" placeholder="Passport Number" value="<?php echo $kids3; ?>"   size="50"></td>
                        <td style="padding-left: 20px">
                             <select name="relation3">
                                <option value="<?php echo $relation3; ?>"><?php echo $relation3; ?></option>
                                <option value="Father">Father</option>
                                <option value="Mother">Mother</option>
                                <option value="Siblings">Siblings</option>
                                <option value="Spouse">Spouse</option>
                    ...
                    <tr>
                        <td style="padding-left: 52px;padding-right:20px"><input type="text" name="spouse4" placeholder="Name" value="<?php echo $spouse4; ?>"   size="40"></td>
                        <td><input type="text" name="kids4" placeholder="Passport Number" value="<?php echo $kids4; ?>"   size="50"></td>
                        <td style="padding-left: 20px">
                             <select name="relation4">
                                <option value="<?php echo $relation4; ?>"><?php echo $relation4; ?></option>
                                <option value="Father">Father</option>
                                <option value="Mother">Mother</option>
                                <option value="Siblings">Siblings</option>
                                <option value="Spouse">Spouse</option>
                    ...
                    <tr>
                        <td style="padding-left: 52px;padding-right:20px"><input type="text" name="spouse5" placeholder="Name" value="<?php echo $spouse5; ?>"   size="40"></td>
                        <td><input type="text" name="kids5" placeholder="Passport Number" value="<?php echo $kids5; ?>"   size="50"></td>
                        <td style="padding-left: 20px">
                             <select name="relation5">
                                <option value="<?php echo $relation5; ?>"><?php echo $relation5; ?></option>
                                <option value="Father">Father</option>
                                <option value="Mother">Mother</option>
                                <option value="Siblings">Siblings</option>
                                <option value="Spouse">Spouse</option>
                    ...
                    <tr>
                        <th> <label>24. Educational Qualification :</label></th>
            ...
            <tr>
                <th colspan="2" ><div align="center"><input type="submit" class="btn btn-success" value="Update"></div></th>
