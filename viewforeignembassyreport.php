...
<div id="printableArea">
    ...
    .row1{
        ...
        <tr>
            ...
            <th colspan="3">
               <div align="center">
                <img src="<?php echo 'images/' . $pp ?>" width="150px" height="150px" alt=" Image Not Found"></div> 
            </th>
        </tr>    
        <tr>
        ...
        <tr>
            <th align="left"  >19. &nbsp;  &nbsp; Office Address</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $Oadd; ?></td>
        </tr> 
        ...
        <tr>
            <th align="left"  >20. &nbsp;  &nbsp;  Residence Address</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $radd; ?></td>
        </tr> 
        ...
        <tr>
            <th align="left">21. &nbsp;  &nbsp;  Contact Details</th>
            <th class ="row1"></th>
            <td></td>
        </tr> 
        <tr>
        ...
        <tr>
            <th align="left"  >22. &nbsp;  &nbsp;  Family Information</th>
            <th class="row1"></th>
            <td></td>
        </tr> 
        ...
        <tr>
            <th align="left"  >23. &nbsp;  &nbsp;  &nbsp; Educational Qualification</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $edu; ?></td>
        </tr> 
        <tr>
            <th align="left"  >24. &nbsp;  &nbsp;  &nbsp; Experience/Previous Posting</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $exp; ?></td>
        </tr> 
        <tr>
            <th align="left"  >25. &nbsp;  &nbsp;  &nbsp; Hobby</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $hobby; ?></td>
        </tr> 

        <tr>
            <th align="left"  >26. &nbsp;  &nbsp;  &nbsp; Special Skills</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $spskills; ?></td>
        </tr> 
        <tr>
            <th align="left"  >27. &nbsp;  &nbsp;  &nbsp; Intelligence Background</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $Intelligence; ?></td>
        </tr> 
        <tr>
            <th align="left"  >28. &nbsp;  &nbsp;  &nbsp; Remarks</th>
            <th class = "row1"><strong>:</strong></th>
            <td><?php echo $remark; ?></td>
        </tr> 
        <tr>
            <th align="left"  >29. &nbsp;  &nbsp;  &nbsp; Other Info (If any)</th>
            <th class = "row1"><strong>:</strong></th>
